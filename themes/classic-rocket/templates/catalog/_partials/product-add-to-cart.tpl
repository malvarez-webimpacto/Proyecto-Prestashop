    ...
    <div class="product-add-to-cart">
        ...
        <div class="product-quantity row align-items-center no-gutters">
            ...
            <div class="qty col-auto">
                <input type="number" name="qty" id="quantity_wanted" value="{$product.quantity_wanted}" class="input-group" min="{$product.minimal_quantity}" aria-label="{l s='Quantity' d='Shop.Theme.Actions'}" {if isset($product.product_url)}data-update-url="{$product.product_url}"
                    {/if}>
            </div>
        ...
        {/block} {block name='product_availability'}
        <span id="product-availability">
            ...
            {/if}
          </span> {/block} {block name='product_minimal_quantity'}
