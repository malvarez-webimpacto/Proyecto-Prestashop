...
<contact@prestashop.com>
    * @copyright 2007-2017 PrestaShop SA * @license https://opensource.org/licenses/AFL-3.0 Academic Free License 3.0 (AFL-3.0) * International Registered Trademark & Property of PrestaShop SA *} {block name='header_banner'}
    ...
    <div class="header-nav u-bor-bot">
        <div class="header__container container">
            <div class="u-a-i-c d--flex-around visible--desktop">
                ...
                <div class="header-nav__right">{hook h='displayNav2'}</div>
            </div>
        </div>
    </div>
    ...
    <div class="container">{hook h='displayNavFullWidth'}</div>
    {/block}
</contact@prestashop.com>